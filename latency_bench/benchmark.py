...
ROOT_DIR = BENCH_DIR.parent.absolute()
...
class Benchmark:
    def __init__(self):
        ...
        self.candidates_path = Path(ROOT_DIR) / "candidates"
    ...
    def run_all_with_cprofile(self):
        for file in self.candidate_files:
            ...
            self.run(file, profiler=True)

    def run(self, script_path=None, profiler=False):
